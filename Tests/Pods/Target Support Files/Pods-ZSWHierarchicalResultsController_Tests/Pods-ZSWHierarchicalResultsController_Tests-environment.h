...
#define COCOAPODS_POD_AVAILABLE_ZSWHierarchicalResultsController
#define COCOAPODS_VERSION_MAJOR_ZSWHierarchicalResultsController 1
#define COCOAPODS_VERSION_MINOR_ZSWHierarchicalResultsController 0
#define COCOAPODS_VERSION_PATCH_ZSWHierarchicalResultsController 0
